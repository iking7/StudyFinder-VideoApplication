import {
  ...
  isUWP,
  registerVersion
} from "./chunk-XLSKXZAP.js";
import "./chunk-2VXGTG27.js";
...
var Blob = class {
  ...
  static fromBase64String(base64) {
    ...
    return new Blob(Xc2.fromBase64String(base64));
  }
  static fromUint8Array(array) {
    assertUint8ArrayAvailable();
    return new Blob(Xc2.fromUint8Array(array));
  }
  toBase64() {
    assertBase64Available();
...
var IndexedDbPersistenceProvider = class {
  enableIndexedDbPersistence(firestore, forceOwnership) {
    return Lc2(firestore._delegate, { forceOwnership });
  }
  enableMultiTabIndexedDbPersistence(firestore) {
    return Bc2(firestore._delegate);
  }
  clearIndexedDbPersistence(firestore) {
    return qc2(firestore._delegate);
  }
};
var Firestore = class {
  constructor(databaseIdOrApp, _delegate, _persistenceProvider) {
    ...
    if (!(databaseIdOrApp instanceof hc2)) {
  ...
  settings(settingsLiteral) {
    ...
    if (!settingsLiteral.merge && currentSettings.host !== settingsLiteral.host) {
      F2("You are overriding the original host. If you did not intend to override your settings, use {merge: true}.");
    }
  ...
  useEmulator(host, port, options = {}) {
    Ec2(this._delegate, host, port, options);
  }
  enableNetwork() {
    return jc2(this._delegate);
  }
  disableNetwork() {
    return Qc2(this._delegate);
  }
  enablePersistence(settings) {
    ...
    if (settings) {
      ...
      dc2("synchronizeTabs", synchronizeTabs, "experimentalForceOwningTab", experimentalForceOwningTab);
    }
  ...
  waitForPendingWrites() {
    return Kc2(this._delegate);
  }
  onSnapshotsInSync(arg) {
    return ph(this._delegate, arg);
  }
  get app() {
    if (!this._appCompat) {
  ...
  collection(pathString) {
    try {
      return new CollectionReference(this, bc2(this._delegate, pathString));
    } catch (e) {
  ...
  doc(pathString) {
    try {
      return new DocumentReference(this, vc2(this._delegate, pathString));
    } catch (e) {
  ...
  collectionGroup(collectionId) {
    try {
      return new Query(this, Pc2(this._delegate, collectionId));
    } catch (e) {
      throw replaceFunctionName(e, "collectionGroup()", "Firestore.collectionGroup()");
    }
  }
  runTransaction(updateFunction) {
    return Ah(this._delegate, (transaction) => updateFunction(new Transaction(this, transaction)));
  }
  batch() {
    Fc2(this._delegate);
    return new WriteBatch(new rh(this._delegate, (mutations) => Th(this._delegate, mutations)));
  }
  loadBundle(bundleData) {
    return Gc2(this._delegate, bundleData);
  }
  namedQuery(name2) {
    return zc2(this._delegate, name2).then((expQuery) => {
      if (!expQuery) {
        return null;
      }
...
var UserDataWriter = class extends nh {
  constructor(firestore) {
    super();
    this.firestore = firestore;
  }
  convertBytes(bytes) {
    return new Blob(new Xc2(bytes));
  }
...
var Transaction = class {
  ...
  get(documentRef) {
    ...
    return this._delegate.get(ref).then((result) => new DocumentSnapshot(this._firestore, new Cu(this._firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, ref.converter)));
  }
...
var FirestoreDataConverter = class {
  ...
  fromFirestore(snapshot, options) {
    const expSnapshot = new Nu(this._firestore._delegate, this._userDataWriter, snapshot._key, snapshot._document, snapshot.metadata, null);
...
var DocumentReference = class {
  ...
  static forPath(path, firestore, converter) {
    ...
    return new DocumentReference(firestore, new Ic2(firestore._delegate, converter, new Pt(path)));
  }
  static forKey(key, firestore, converter) {
    return new DocumentReference(firestore, new Ic2(firestore._delegate, converter, key));
  }
  get id() {
  ...
  collection(pathString) {
    try {
      return new CollectionReference(this.firestore, bc2(this._delegate, pathString));
    } catch (e) {
  ...
  isEqual(other) {
    ...
    return Vc2(this._delegate, other);
  }
  set(value, options) {
    options = validateSetOptions("DocumentReference.set", options);
    try {
      if (options) {
        return wh(this._delegate, value, options);
      } else {
        return wh(this._delegate, value);
      }
    } catch (e) {
  ...
  update(fieldOrUpdateData, value, ...moreFieldsAndValues) {
    try {
      if (arguments.length === 1) {
        return _h(this._delegate, fieldOrUpdateData);
      } else {
        return _h(this._delegate, fieldOrUpdateData, value, ...moreFieldsAndValues);
      }
    } catch (e) {
  ...
  onSnapshot(...args) {
    ...
    const observer = wrapObserver(args, (result) => new DocumentSnapshot(this.firestore, new Cu(this.firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, this._delegate.converter)));
    return yh(this._delegate, options, observer);
  }
  get(options) {
    let snap;
    if ((options === null || options === void 0 ? void 0 : options.source) === "cache") {
      ...
      snap = hh(this._delegate);
    } else {
      snap = ah(this._delegate);
    }
    return snap.then((result) => new DocumentSnapshot(this.firestore, new Cu(this.firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, this._delegate.converter)));
  }
...
var DocumentSnapshot = class {
  ...
  isEqual(other) {
    return $u(this._delegate, other._delegate);
  }
};
var QueryDocumentSnapshot = class extends DocumentSnapshot {
  data(options) {
    const data = this._delegate.data(options);
    U2(data !== void 0, "Document in a QueryDocumentSnapshot should exist");
    return data;
  }
};
var Query = class {
  ...
  where(fieldPath, opStr, value) {
    try {
      return new Query(this.firestore, Mu(this._delegate, Bu(fieldPath, opStr, value)));
    } catch (e) {
  ...
  orderBy(fieldPath, directionStr) {
    try {
      return new Query(this.firestore, Mu(this._delegate, qu(fieldPath, directionStr)));
    } catch (e) {
      throw replaceFunctionName(e, /(orderBy|where)\(\)/, "Query.$1()");
    }
  }
  limit(n) {
    try {
      return new Query(this.firestore, Mu(this._delegate, ju(n)));
    } catch (e) {
  ...
  limitToLast(n) {
    try {
      return new Query(this.firestore, Mu(this._delegate, Qu(n)));
    } catch (e) {
  ...
  startAt(...args) {
    try {
      return new Query(this.firestore, Mu(this._delegate, Gu(...args)));
    } catch (e) {
  ...
  startAfter(...args) {
    try {
      return new Query(this.firestore, Mu(this._delegate, zu(...args)));
    } catch (e) {
  ...
  endBefore(...args) {
    try {
      return new Query(this.firestore, Mu(this._delegate, Ju(...args)));
    } catch (e) {
  ...
  endAt(...args) {
    try {
      return new Query(this.firestore, Mu(this._delegate, Yu(...args)));
    } catch (e) {
      throw replaceFunctionName(e, "endAt()", "Query.endAt()");
    }
  }
  isEqual(other) {
    return Sc2(this._delegate, other._delegate);
  }
  get(options) {
    let query;
    if ((options === null || options === void 0 ? void 0 : options.source) === "cache") {
      query = fh(this._delegate);
    } else if ((options === null || options === void 0 ? void 0 : options.source) === "server") {
      query = dh(this._delegate);
    } else {
      query = lh(this._delegate);
    }
    return query.then((result) => new QuerySnapshot(this.firestore, new xu(this.firestore._delegate, this._userDataWriter, this._delegate, result._snapshot)));
  }
  onSnapshot(...args) {
    const options = extractSnapshotOptions(args);
    const observer = wrapObserver(args, (snap) => new QuerySnapshot(this.firestore, new xu(this.firestore._delegate, this._userDataWriter, this._delegate, snap._snapshot)));
    return yh(this._delegate, options, observer);
  }
  withConverter(converter) {
...
var CollectionReference = class extends Query {
  ...
  doc(documentPath) {
    try {
      if (documentPath === void 0) {
        return new DocumentReference(this.firestore, vc2(this._delegate));
      } else {
        return new DocumentReference(this.firestore, vc2(this._delegate, documentPath));
      }
    } catch (e) {
  ...
  add(data) {
    return gh(this._delegate, data).then((docRef) => new DocumentReference(this.firestore, docRef));
  }
  isEqual(other) {
    return Vc2(this._delegate, other._delegate);
  }
  withConverter(converter) {
...
function castReference(documentRef) {
  return gc2(documentRef, Ic2);
}
var FieldPath = class {
  constructor(...fieldNames) {
    this._delegate = new Jc2(...fieldNames);
  }
  static documentId() {
...
var FieldValue = class {
  ...
  static arrayUnion(...elements) {
    const delegate = Ph(...elements);
    delegate._methodName = "FieldValue.arrayUnion";
    return new FieldValue(delegate);
  }
  static arrayRemove(...elements) {
    const delegate = vh(...elements);
